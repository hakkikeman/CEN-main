...
# Model SİMETRİK çalışıyor: Önce MLO'yu CC bağlamıyla, sonra CC'yi MLO bağlamıyla değerlendiriyor"
# Loss fonksiyonu nn.BCELoss() — Binary Cross Entropy, çünkü her proposal ya kanser ya değil"
