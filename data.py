...
# "Her hasta klasöründe:
# - Malignant hasta: 6 dosya (MLO.png, CC.png, MLO_preds.txt, CC_preds.txt, MLO.txt, CC.txt)
# - Benign hasta:    4 dosya (MLO.png, CC.png, MLO_preds.txt, CC_preds.txt)
# Kod, klasördeki dosya sayısından otomatik olarak hastanın malignant mı 
# benign mi olduğunu anlıyor (satır 105: mal = 1 if len(os.listdir(folder_path))==6 else 0)"
